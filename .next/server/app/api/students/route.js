(()=>{var a={};a.id=150,a.ids=[150],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},1804:(a,b,c)=>{"use strict";function d(a,b,c){let d=Error(b);return d.status=a,d.details=c,d}c.d(b,{V:()=>d})},3295:a=>{"use strict";a.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},4573:a=>{"use strict";a.exports=require("node:buffer")},10846:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},19121:a=>{"use strict";a.exports=require("next/dist/server/app-render/action-async-storage.external.js")},19485:(a,b,c)=>{"use strict";c.d(b,{S:()=>e});var d=c(77598);function e(){return(0,d.randomUUID)()}},19771:a=>{"use strict";a.exports=require("process")},21820:a=>{"use strict";a.exports=require("os")},22267:(a,b,c)=>{"use strict";c.d(b,{Lw:()=>f,bd:()=>g,z3:()=>e});var d=c(1804);function e(a,b){let c=b.filter(b=>{let c=a[b];return null==c||""===c});if(c.length>0)throw(0,d.V)(400,"Missing required fields.",{missing:c})}function f(a,b){if("number"!=typeof a||Number.isNaN(a)||a<=0)throw(0,d.V)(400,`${b} must be a positive number.`)}function g(a,b,c){if(!b.includes(a))throw(0,d.V)(400,`${c} must be one of: ${b.join(", ")}.`)}},24035:(a,b,c)=>{"use strict";c.d(b,{LP:()=>o,Nm:()=>k,dp:()=>n,s5:()=>m,w0:()=>l});var d=c(74639),e=c(19485),f=c(1804),g=c(22267),h=c(56420);async function i(a){if(0===(await (0,d.P)("SELECT id FROM institutions WHERE id = $1",[a])).rowCount)throw(0,f.V)(404,"Institution not found.")}async function j(a,b){if(a&&0===(await (0,d.P)("SELECT id FROM academic_classes WHERE id = $1 AND institution_id = $2",[a,b])).rowCount)throw(0,f.V)(404,"Class not found for this institution.")}async function k(a={}){let b=[],c=[];a.institutionId&&(c.push(a.institutionId),b.push(`institution_id = $${c.length}`));let e=b.length>0?`WHERE ${b.join(" AND ")}`:"",f=await (0,d.P)(`SELECT * FROM students ${e} ORDER BY created_at DESC`,c);return(0,h.K)(f.rows)}async function l(a){let b=await (0,d.P)("SELECT * FROM students WHERE id = $1",[a]);if(0===b.rowCount)throw(0,f.V)(404,"Student not found.");return(0,h.e)(b.rows[0])}async function m(a){(0,g.z3)(a,["institutionId","firstName","admissionNumber"]),await i(a.institutionId),await j(a.classId,a.institutionId);let b=(0,e.S)();try{return await (0,d.P)(`
      ...
      `,[b,a.institutionId,a.admissionNumber.trim(),a.firstName.trim(),a.lastName?.trim()||"",a.motherName?.trim()||null,a.fatherName?.trim()||null,a.aadhaarNumber?.trim()||null,a.email?.trim()||null,a.phone?.trim()||null,a.address?.trim()||null,a.dob||null,a.course?.trim()||null,a.className?.trim()||null,a.classId||null,a.section?.trim()||null,a.status?.trim()||"ACTIVE"]),l(b)}catch(a){if("ER_DUP_ENTRY"===a.code)throw(0,f.V)(409,"Admission number already exists for this institution.");throw a}}async function n(a,b){let c=await l(a),e=b.institutionId??c.institutionId;await i(e);let g=void 0!==b.classId?b.classId||null:c.classId;await j(g,e);try{return await (0,d.P)(`
        UPDATE students
        SET
          institution_id = $2,
          admission_number = $3,
